...
def generate_report(
    ...
    # Define all enhanced Finbit metrics in order
    finbit_metrics = [
        # Core Finbit metrics
        ...
        ("digitalTransferCredit", "Digital Transfer Credit"),
        ("digitalTransferDebit", "Digital Transfer Debit"),
        ("interestCredit", "Interest Credit"),
        ("interestDebit", "Interest Debit"),
        ("insurancePremium", "Insurance Premium"),
        ("largestCredit", "Largest Credit"),
        ("largestDebit", "Largest Debit"),
        ("medianBalance", "Median Balance"),
        ("balanceVolatility", "Balance Volatility"),
        ("incomeStabilityScore", "Income Stability Score"),
        ("expenseRatio", "Expense Ratio (%)"),
        
        # Risk indicators
        ("chequeBounceCount", "Total Cheque Bounces"),
        ("lowBalanceDays", "Low Balance Days (<1000)"),
        ("overdrawnDays", "Overdrawn Days (<0)"),
        
        # Top transactions
        ("top5CreditAmount", "Top 5 Credit Amount"),
        ("top5DebitAmount", "Top 5 Debit Amount"),
        ("top5CreditPercentage", "Top 5 Credit %"),
        ("top5DebitPercentage", "Top 5 Debit %"),
    ...
    # Column widths
    ws9.set_column(0, 0, 28)  # Metric name
        ...
        for c_idx, m_label in enumerate(finbit_months, 1):
            ...
            if isinstance(val, (int, float)):
                if metric_key in ["inwBounce", "outwBounce", "chequeBounceCount", "lowBalanceDays", "overdrawnDays"]:
                    ...
                    ws9.write_number(r_idx, c_idx, val, fmt_percent)
                else:
