"""
Airco Insights — SBI Bank Recurring Engine
=============================================
Detects recurring transactions for SBI Bank.
"""
...
class SBIRecurringEngine:
    ...
    def detect(self, transactions: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        self.logger.info("Detecting recurring patterns in %d SBI transactions", len(transactions))
