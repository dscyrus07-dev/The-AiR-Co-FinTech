"""
Airco Insights — SBI Bank Formula Excel Engine
"""
...
class FormulaExcelEngine:
    ...
    def generate(
        ...
        user_info = {
            ...
            "bank_name":    "SBI Mahindra Bank",
        }
        self.logger.info("FormulaExcelEngine: generating SBI report for %d transactions", len(transactions))
