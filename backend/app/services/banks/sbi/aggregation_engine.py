"""
Airco Insights — SBI Bank Aggregation Engine
===============================================
Financial analytics and aggregation for SBI Bank transactions.
"""
...
class SBIAggregationEngine:
    ...
    def aggregate(
        ...
        self.logger.info("Aggregating %d SBI transactions", len(transactions))
