"""
Airco Insights — ICICI Bank Recurring Engine
=============================================
...
class ICICIRecurringEngine:
    """Recurring transaction detection for ICICI Bank."""

    SUBSCRIPTION_MERCHANTS = {
        "netflix", "hotstar", "prime", "spotify", "apple", "youtube",
        "gaana", "wynk", "jiosaavn", "zee5", "sonyliv",
        "linkedin", "microsoft", "google", "adobe", "dropbox",
    }
    EMI_PATTERNS = [
        r"ECS.*DEBIT.*", r"NACH.*DEBIT.*", r".*EMI.*", r"LIC.*HOUSING",
        r"HOME.*LOAN", r"CAR.*LOAN",
    ]
    UTILITY_PATTERNS = [
    ...
    def _get_merchant_key(self, txn: Dict[str, Any]) -> str:
        ...
        for prefix in ["UPI/", "NEFT/", "IMPS/", "ECS-", "NACH-"]:
